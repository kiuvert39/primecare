import { site, nav, footer } from "@/data";
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-1">
              {[
                ...
                <a key={label} href={href} aria-label={label}
                  className="w-8 h-8 rounded-lg bg-neutral-800 hover:bg-primary
            ...
            <div className="flex items-center gap-2 mt-2">
              ...
              <span className="text-[11px] text-neutral-500 font-medium">{footer.badge}</span>
            </div>
          </div>
          ...
          {footer.columns.map((col) => (
            <div key={col.heading} className="flex flex-col gap-3">
              <h4 className="text-xs font-bold uppercase tracking-[0.15em] text-white mb-1">
                {col.heading}
              </h4>
              {col.links.map((link) => (
